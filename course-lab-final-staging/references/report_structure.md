...
This summary is distilled from local decoded reference reports, with Modern Physics materials serving as one strong example in the current repository layout.
...
- Treat Modern Physics as a supported default case, not as the only course family the skill can serve.
