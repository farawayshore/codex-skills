...
class CourseLabFinalStagingPackageTests(unittest.TestCase):
    ...
    def test_skill_markdown_uses_local_paths_and_documents_boundary(self) -> None:
        ...
        self.assertIn("references-json", text.lower())
        self.assertIn("confirmed references", text.lower())
        ...
        self.assertIn("symbolic handout", text.lower())
        self.assertIn("symbolic calculation code", text.lower())
        self.assertIn("symbolic processed result", text.lower())
        self.assertIn("symbolic result key", text.lower())
        self.assertIn("symbolic output dir", text.lower())
        self.assertIn("tex_path", text)
        self.assertIn("optional helper", text.lower())
        self.assertIn("not a required stage", text.lower())
        self.assertIn("does not mutate `main.tex`", text.lower())
